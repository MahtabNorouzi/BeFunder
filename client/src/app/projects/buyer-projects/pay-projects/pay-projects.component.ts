...
@Component({
  selector: 'app-pay-projects',
  templateUrl: './pay-projects.component.html',
  styleUrls: ['./pay-projects.component.css']
})
export class PayProjectsComponent implements OnInit {
        ...
        .then((ProjectAbstraction) => {
          ...
          projects.forEach((projectAddress) => {
            ...
            ProjectAbstraction.at(projectAddress).then((data) => {
              ...
              data.getDetailsForBuyerPayment({ from: this.auth.instantUser.ethAddress })
                .then((res) => {
                  console.log('res.state.:', res.currentState.toString());
                  console.log('investors:', res.investors);
  ...
  async fundProjectByBuyer(data, index) {
        ...
        ProjectAbstraction.at(projectContract).then((data) => {
          ...
          then((res)=> {
            ...
            data.buyerPay({
              ...
              value: Web3.utils.toWei(res.goalAmount, 'ether')
            })
          });
        });
      })
